...
./track_and_map_files.py --watch-dir /analyse/Project0404/brain_age/data/project_name/ \
    --logdir /analyse/Project0404/brain_age/data/project_name/raw/

In a new terminal:
mv /analyse/Project0404/brain_age/data/project_name/raw/T1w_images/*.nii.gz \
    /analyse/Project0404/brain_age/data/project_name/imgs/anat/
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Watch for file moves under a directory and log them to CSV.")
    parser.add_argument("-w", "--watch-dir", required=True, help="Directory tree to monitor (recursive)")
    parser.add_argument("-l", "--logdir", required=True, help="Path to CSV file where moves will be logged")
